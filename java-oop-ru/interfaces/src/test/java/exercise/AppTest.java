...
class AppTest {
    ...
    void testBuildReversedSequence1() {
        ...
        assertThat(text.toString()).isEqualTo(expected); // "fedcba"
        char expectedChar = 'e';
        assertThat(text.charAt(1)).isEqualTo(expectedChar);
        int expectedLength = 6;
        assertThat(text.length()).isEqualTo(expectedLength);
        String expectedSubSequence = "edc";
        assertThat(text.subSequence(1, 4).toString()).isEqualTo(expectedSubSequence);
    ...
    void testCompareTo() {
        ...
        Cottage cottage1 = new Cottage(100, 1);
        Cottage cottage2 = new Cottage(250,3);
        Flat flat1 = new Flat(200, 10, 2);
        Flat flat2 = new Flat(180, 30, 5);


        assertThat(cottage1.compareTo(cottage2)).isEqualTo(-1);
        assertThat(cottage2.compareTo(flat1)).isEqualTo(1);
        assertThat(flat1.compareTo(flat2)).isEqualTo(0);
