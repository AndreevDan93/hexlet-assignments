...
public class AppTest {
    ...
    void testPatchPersonByID() throws Exception {
        MockHttpServletResponse patchResponse = mockMvc.perform(
                patch("/people/1").contentType(MediaType.APPLICATION_JSON)
                        .content("{\"firstName\": \"Dan\", \"lastName\": \"Andreev\"}"))
                .andReturn().getResponse();
        ...
        assertThat(getResponse.getContentAsString()).contains("Dan", "Andreev");
    }
    ...
    void testDeletePersonById() throws Exception {
        ...
        assertThat(getResponse.getContentAsString()).doesNotContain("John", "Smith");
    }
